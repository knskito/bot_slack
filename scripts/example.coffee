...
module.exports = (robot) ->
    robot.hear /(遅刻|遅れます|寝坊|出社|出勤|到着)/, (msg) ->
        ...
        if n <= 20
            ...
            msg.send "時間を守らない、すなわち自己管理すら出来ていない人間が、日本の美術界に変革を起こすことなど出来るはずも無いだろう。悪口を言いたいんじゃない。でも、上っ面の態度だけじゃない。本当に行動に出る人間がほしいんだ。人のために動ける人間と一緒に働きたいんだ。僕は行動する。スタートバーン全員も行動する人間になれ！嫌ならこんな変な会社、辞めるべきです。僕は会社を作って皆に働いてもらって、、、とか 考えてきた時期もあったが、安保関連法案の可決以降、フェーズが変わった。僕らは社会貢献のため、組織化し、「美しさ」を基盤にして社会に革命を起こす集団になるべきだ。雇用条件や休暇とか、そう言うことばかり言う奴は今すぐ、退職金を手に、退社してほしい。それがお互いの為です。"
