...
module.exports = (robot) ->
    robot.hear /(遅刻|遅れます|寝坊|出社|出勤|到着)/, (msg) ->
        ...
        if n <= 20
            ...
            msg.send "時間を守らない、すなわち自己管理すら出来ていない人間が、日本の美術界に変革を起こすことなど出来るはずも無いだろう。悪口を言いたいんじゃない。でも、上っ面の態度だけじゃない。本当に行動に出る人間がほしいんだ。人のために動ける人間と一緒に働きたいんだ。僕は行動する。スタートバーン全員も行動する人間になれ！嫌ならこんな変な会社、辞めるべきです。僕は会社を作って皆に働いてもらって、、、とか 考えてきた時期もあったが、安保関連法案の可決以降、フェーズが変わった。僕らは社会貢献のため、組織化し、「美しさ」を基盤にして社会に革命を起こす集団になるべきだ。雇用条件や休暇とか、そう言うことばかり言う奴は今すぐ、退職金を手に、退社してほしい。それがお互いの為です。先般、早稲田を中退してわざわざ入社してきた伊東くんが突然退社しました。彼は元気よく、口先は華々しいものがあった。でも、ついてこれなかった。そして、それが正しい選択なのです。＜自分自分＞の人間はこの会社の社風に合わない。思いやり。優しさ。社会貢献。そして、それらを「美しく」行える美意識、信念を持て。それがスタートバーンという会社の基本理念だ。以上です。"
        else if n > 40 and n <= 60
            msg.send "アメリカに住み暮らしていつも思う事は、この国は戦時下にあるってこと。戦争して国家を起動させてる。その国の傀儡下で呑気にぬるま湯が気持ちがいい、と、惰眠をむさぼるチョイスをしたのが日本国民自身だったのです。で、この結果だ。舐めるな日本の若い芸術家志望のぼんくらども！知ったような事言って飲み屋で自画自賛しあってるクラスタなんか２年後に跡形もないんだぜ！"
            ...
            msg.send "昨今、スタートバーンに入ってくる若者の特徴がはっきりしている。 1: 第一印象がいい。挨拶など表層はいい。2: その割に時間を守らず、ヘタレると行方をくらます。3: 身なりがスッキリしてる。4: 対外関係がうまく行えず、そういう事実も隠蔽している。5: 4や私からの叱責が繰り返され退社してゆく。6: 退社時のメールでの挨拶で己の夢を語ったり、「勉強になった」などとのたまい、自身の置かれた立場を理解していない。等など... この辺り、どう思うよ、社員の皆さん方よ？〇〇が悪い！って告発することがポイントじゃないんだよ！己の行動、己の規範を見なおそうぜ、って言いたいんだよ、俺は。"
