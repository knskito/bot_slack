module.exports = (robot) ->
    robot.hear /(遅刻|遅れます|寝坊|出社|出勤|到着)/, (msg) ->
        ...
        if n <= 20
            ...
            msg.send "無菌な若者達を増長させずに乗らせてしまい、下手に私もやんやん言って来たので、身の丈以上のトレンドになってしまい、そして、内容が全く無いという状況こそが自分たちの存在意義だと言う学生紛争時代的レトリックでふんぞり返っており、下手に自信も持って来てしまっておりまさにシーンへの悪影響が懸念され始めた昨今、、、という状況下に、今回の遅刻という事件が起こったのです。"
        else
